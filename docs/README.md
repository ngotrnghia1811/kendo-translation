...
Living reference documentation for the kendo-translation platform (PocketBase-era,
production at [kendotranslation.com](https://kendotranslation.com)).
...
| File | What it was |
|------|-------------|
| AGENT-COORDINATION.md | Agent-task coordination handoff notes |
...
| DEV-STATE-2026-06-03.md | Development state snapshot (2026-06-03) |
| FE-COORD-BOOKSIZE-SCALING-2026-05-30.md | Frontend coordination — booksize scaling |
...
| TRANSLATOR-ADMIN-VIEW-PLAN.md | Translator/admin view implementation plan |
| UNTRANSLATED-REMAINDER.md | Untranslated-remainder tracking plan |
| USER-FLOW-TEST-PLAN-2026-06-16.md | User-flow test plan (2026-06-16) |
