...
export default function TranslationEditor({
    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            {/* Column headers */}
            <div className="grid grid-cols-[40px_1fr_1fr] gap-0 border-b border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-xs font-medium text-gray-500 uppercase tracking-wide">
                <div className="p-2 text-center border-r border-gray-200 dark:border-gray-700">#</div>
            ...
            {/* Status bar */}
            <div className="sticky bottom-0 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-4 py-2 text-xs text-gray-500 flex items-center justify-between">
